...
separator="tab"
  ...
  if(group=="sudo"){
    params <- paste("--cidfile ",data.folder,"/dockerID -v ",scrat_tmp.folder,":/scratch -v ", data.folder, ":/data -d lorenz Rscript /home/main.R ",matrixName," ",p_value," ",format," ",separator, sep="")
