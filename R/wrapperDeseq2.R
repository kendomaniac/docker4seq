...
#' @description This function runs deseq2 on a table generated with sample2experiment having the covariates added in the names of the columns, separated by the names with underscore.
...
#' @param type, character with three options: gene, isoform, mirna. if gene is used two files are generated for geneset enrichment, the filtered Gene symbols and the background that contains all gene symbols.
