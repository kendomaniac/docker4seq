#' @title Preparing the GTF file required by starchip to detect circular RNAs on paired-end sequences
#' @description This function prepare the genome GTF for starchip, the GTF must be the one used by starChimeric
#' @param group, a character string. Two options: sudo or docker, depending to which group the user belongs
#' @param genome.folder, a character string indicating where gzip fastq files are located
