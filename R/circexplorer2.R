#' @title Running CIRCexplorer2 parse command for circRNAs prediction from STAR/BWA alignment output
#' @description This function executes the circexplorer2 docker container which parses the fusion file generated by STAR/BWA and extracts circRNA coordinates
