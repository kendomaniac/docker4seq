...
#' @description This function executes a docker that cnvert the transcripts count file generated by Salmon quasi-alignment in the same format of te ?writes of RSEM
...
#' salmonCounts(group="docker", fastq.folder=getwd(), 
