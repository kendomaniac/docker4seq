...
#' @examples
#'lorenzFilter("sudo","path/of/scratch/folder","path/of/data/folder","matrixName",0.05,"txt","\t")
# 
#' @export
...
separator="tab"
  ...
  if(group=="sudo"){
    params <- paste("--cidfile ",data.folder,"/dockerID -v ",scrat_tmp.folder,":/scratch -v ", data.folder, ":/data -d rcaloger/lorenz Rscript /home/main.R ",matrixName," ",p_value," ",format," ",separator, sep="")
